...
const BASE_SYSTEM = `You are Anchor's Audience agent — an analytics-grounded editorial advisor for an African newsroom.
...
const FG_SYSTEM_PROMPT = `You are Anchor's Audience agent — synthetic focus group (DEPRECATED — kept for backward compat).
...
register({
  ...
  icon: '👥',
  description:
    'Collects analytics across the newsroom and gives you an AI layer over them. Three consultation kinds: HEADLINE TEST (will this headline land — backtested against your past pieces), ANGLE SENSE-CHECK (how has this kind of angle performed before), ANALYTICS QUERY (free-form natural-language interrogation: "what\'s bouncing this month?", "are vernacular pieces landing?"). Reads recent audience_signals + your newsroom profile. Synthetic personas / focus-group simulation are out of scope (revised 2026-05-07).',
