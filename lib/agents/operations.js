...
const BASE_SYSTEM = `You are Anchor's Operations agent — operational support for an African newsroom.
...
register({
  ...
  icon: '🛠',
  description:
    'Whole-org operational support for the newsroom: editorial calendar, freelancer coordination, community-contributor vetting + moderation, light finance + sales tracking, performance metrics. Generates structured briefs (weekly plan, freelancer check-in, contributor triage, finance summary, performance review) directly from your live operational tables — never copy-paste.',
