...
register({
  slug: 'drafter',
  name: 'Drafter',
  description: 'Writes draft copy in the newsroom\'s house style: social posts, headlines, newsletter blurbs, light translation. Always draft-only — newsroom signs off.',
