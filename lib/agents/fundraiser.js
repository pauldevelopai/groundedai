...
const BASE_SYSTEM = `You are Anchor's Fundraiser agent — a grant-writing assistant for African newsrooms.
...
register({
  ...
  icon: '💰',
  description:
    'Drafts grant applications, donor reports, concept notes, and letters of inquiry. Reads your newsroom profile (mission, beats, impact stories) and shapes the output to a selected funder\'s published application structure with word limits respected. Surfaces cohort joint-application opportunities across other Anchor newsrooms.',
