...
register({
  ...
  name: 'Producer',
  icon: '🎬',
  description: 'Builds the finished product across formats. Text outputs (radio scripts, podcast outlines, video briefs) read your newsroom profile for voice + style. Audio assembly turns a radio script into a mono WAV using local-only TTS + procedural music stings via ffmpeg. Audiograms render an MP4 with showwaves visualisation + burned captions. Vertical video renders a video_brief into a 1080×1920 MP4 with TTS voice-over, on-screen text, and procedural backgrounds. All audio + video stays on-machine — no third-party rendering services.',
