...
register({
  ...
  name: 'Translator',
  icon: '🌐',
  description: 'Translates between English and South African languages with depth — using your newsroom glossary, OSS open-source models routed per language pair (Helsinki-NLP opus-mt where it exists; NLLB-200 distilled for the rest), and editor sign-off. Covers Afrikaans, isiZulu, isiXhosa, Sesotho, Setswana, Siswati, isiNdebele, and Sepedi.',
