...
register({
  ...
  name: 'Translator',
  icon: '🌐',
  description: 'Translates between English and South African languages with depth — using your newsroom glossary, an OSS open-source model per language pair, and editor sign-off. Slice 7a ships en↔af / en↔zu / en↔xh; more pairs on the way.',
