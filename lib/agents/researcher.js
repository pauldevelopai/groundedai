...
const SYSTEM_BASE = `You are Anchor's Researcher agent — a research assistant for African newsrooms working with court filings, regulatory disclosures, financial documents, and other primary source material.
...
register({
  ...
  name: 'Researcher',
  icon: '🔎',
  description: 'Pulls public records, court filings, regulatory disclosures, and financial documents. Extracts entities, relationships, key claims, follow-up questions, and suggested records to chase. Pairs with research dossiers in /research for ongoing investigations.',
  ...
  config: {
    ...
    model: {
      ...
      label: 'Model tier',
      description: 'Haiku is the cheap-and-fast default (~$0.01–0.03 per document). Sonnet costs ~5× more for tougher reasoning. Opus costs ~19× more — only worth it for forensic work on long, dense filings.',
      options: [
        { value: 'claude-haiku-4-5-20251001', label: 'Haiku 4.5 — fast & cheap (default)' },
        { value: 'claude-sonnet-4-6', label: 'Sonnet 4.6 — balanced' },
        { value: 'claude-opus-4-7', label: 'Opus 4.7 — slow & deep' },
      ],
    },
  },
  outputs: {
