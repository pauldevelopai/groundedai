...
// solve?" and "what product does this build?". On pick, Anchor seeds the
...
const STARTERS = [
  // ─── Fact-checking ────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the article you want to fact-check. Anchor pulls relevant past coverage from your archive, then surfaces each claim with a verdict, evidence, and the bits you should independently confirm.',
    definition: {
      nodes: [
  ...
  },
  {
    ...
    problem_category: 'Fact-checking',
    user_instructions: 'Paste the tip exactly as it came in. Anchor extracts the claims, checks them against your archive, and flags what to confirm independently before you act on it.',
    definition: {
      nodes: [
  ...
  // ─── Production ────────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the article you want to repackage. Anchor returns three social posts, a newsletter blurb, and three headline alternatives — review and pick.',
    definition: {
      nodes: [
  ...
  },
  {
    ...
    problem_category: 'Production',
    user_instructions: 'Paste the article. Anchor produces a podcast intro (cold-open) and outline you can use for solo, two-host, or interview formats. Producer agent will pick this up later for full audio assembly.',
    definition: {
      nodes: [
  ...
  },
  {
    ...
    problem_category: 'Production',
    user_instructions: 'Paste the article. Anchor returns a vertical-video script with a 1-line opening hook plus 30-60 seconds of talking-head timing cues.',
    definition: {
      nodes: [
  ...
  // ─── Translation ───────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the article and tell Anchor which language to translate into. The output is a draft — your editor signs it off. Deeper translation work with confidence scoring is coming with the Translator agent.',
    definition: {
      nodes: [
  ...
  // ─── Archive ───────────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Type a topic, question, or angle. Anchor returns the most relevant passages from your newsroom\'s archive with citations.',
    definition: {
      nodes: [
  ...
  },
  {
    ...
    problem_category: 'Archive',
    user_instructions: 'Paste the topic, question, or a paragraph from the story you\'re drafting. Anchor pulls the matching archive passages with citations.',
    definition: {
      nodes: [
  ...
  // ─── Audience research ────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the headline and a 1-line summary of the story. Anchor will run it past synthetic audience personas (built from your real reader data) and surface where it lands and where it fails.',
  ...
  },
  {
    ...
    problem_category: 'Audience research',
    user_instructions: 'Paste the headline + lede + intended audience. Anchor will run it past audience personas grounded in your real reader behaviour.',
    definition: { nodes: [], edges: [], inputs: [], output: { node: '', field: '' } },
  },
  ...
  // ─── Personalisation ───────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the article and tell Anchor which audience segment to write for (e.g. "feature-phone readers in rural Lusaka"). Anchor returns three short summaries shaped for that audience.',
    definition: {
      nodes: [
  ...
  // ─── Social media ─────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the article. Anchor returns posts shaped for X (≤280 chars), LinkedIn, and Instagram — each with its own voice. Pick what fits.',
    definition: {
      nodes: [
  ...
  // ─── Delivery ──────────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the story. Anchor returns a newsletter blurb (~100 words) with a click-through hook.',
    definition: {
      nodes: [
  ...
  // ─── Revenue ──────────────────────────────────────────────────────────
  {
    ...
    user_instructions: 'Paste the period\'s headline coverage + any impact metrics you have. Anchor returns a draft donor report mapped to a typical funder structure. Fundraiser agent will pick this up for funder-specific templates later.',
    definition: { nodes: [], edges: [], inputs: [], output: { node: '', field: '' } },
  },
  ...
  // ─── Editorial operations ─────────────────────────────────────────────
  {
    ...
    user_instructions: 'Type the brief topic. Anchor pulls relevant past coverage from your archive and drafts a brief that frames the story against what you\'ve already published.',
    definition: {
      nodes: [
        { id: 'n1', agent_slug: 'archivist', config: { top_k: '5' }, position: { x: 80, y: 80 } },
