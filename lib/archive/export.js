...
// newsroom_anonymous_id is HMAC-SHA-256(newsroom_id, ANCHOR_DISTRIBUTION_KEY)
...
// export. Private key is encrypted at rest with ANCHOR_DISTRIBUTION_KEY
...
function anonymiseNewsroomId(newsroomId) {
  const secret = process.env.ANCHOR_DISTRIBUTION_KEY || newsroomId; // dev fallback
