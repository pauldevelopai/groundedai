...
- **Anchor → Grounded.** The platform was renamed on 2026-05-11. Some code identifiers (env vars `ANCHOR_*`, the `ANCHOR_MODEL` constant, the npm package name `anchor`, the dev-seed login `admin@anchor.local`) are intentionally unchanged.
